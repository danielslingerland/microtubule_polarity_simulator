...
int main() {
    ...
    double bplpt[41];// = {0.00000000, 0.00000005, 0.00000008, 0.00000010, 0.00000011, 0.000000115, 0.00000012, 0.000000125, 0.00000013, 0.00000014, 0.00000015, 0.00000016, 0.00000017, 0.00000018, 0.00000019, 0.00000020, 0.00000021, 0.00000023, 0.00000025, 0.00000030};
    double bpnpt[41];
    int count[20];
    double p_right[41];
    for(int b = 0; b < 41; b++) {
